...
/**
 * * Test behavior of Memory mapped buffer types. Create a file, write * some
 * data to it, then create three different types of mappings * to it. Observe
 * the effects of changes through the buffer APIs * and updating the file
 * directly. The data spans page boundaries * to illustrate the page-oriented
 * nature of Copy-On-Write mappings. ** @author Ron Hitchens (ron@ronsoft.com)
 */
