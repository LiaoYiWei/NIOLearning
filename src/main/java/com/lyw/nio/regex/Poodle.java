...
/**
 * Demonstrate behavior of splitting strings. The XML output created here can be
 * styled into HTML or some other useful form. See poodle.xsl.
 * 
...
public class Poodle {
	 ...
	 * should probably use the JAX APIs * to do this, but I want to keep the
	 * code simple.
	 */
	private static void generateTable(String input, Pattern[] patterns,
		...
		for (int i = 0; i < patterns.length; i++) {
			...
			System.out.println("\t\t<head>Regex: <value>" + pattern.pattern()
					+ "</value></head>");
		}
		System.out.println("\t</row>");
